    ...
    <div className="sidebar">
      <div className="sidebar-field">
        <svg
          ...
          viewBox="0 0 35 35"
          fill="none"
          id="svg-1854193755_897"
        >
          <mask
            id="svg-1854193755_897_mask0_17717_10557"
          ...
          <g mask="url(#svg-1854193755_897_mask0_17717_10557)">
            <path
              d="M13.9983 0V14.0005L7.89147 7.89171C7.32421 7.3197 7.0041 6.54791 7 5.74233V0H13.9983Z"
              fill="#04AE56"
            ></path>
            <path
              d="M27.9975 14.0006H13.9922L20.1058 7.89178C20.3907 7.60407 20.7307 7.37681 21.1055 7.22363C21.4804 7.07045 21.8822 6.99449 22.2871 7.00031H28.0275L27.9956 14.0006H27.9975Z"
              fill="#04AE56"
            ></path>
            <path
              d="M13.9966 28V13.9995L20.1025 20.116C20.3906 20.4008 20.6182 20.741 20.7714 21.116C20.9246 21.491 21.0003 21.8932 20.994 22.2983V28.0396L13.9966 28ZM0 14.0005H13.9966L7.88978 20.1083C7.31931 20.6787 6.54581 20.9998 5.74039 20.9998H0V13.9995V14.0005Z"
              fill="#04AE56"
            ></path>
          </g>
        </svg>
        <BoltIcon className="sidebar-icon" />
        <PhotoIcon className="sidebar-icon" />
        <svg
